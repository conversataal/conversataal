    ...
    render() {
        return (
            <div className="container">
                ...
                />
                <div className="row">
                    <div className="col s12 l8 offset-l2" style={{backgroundColor: '#d9d9d9', marginTop: '0.5em'}}>
                        <h3>Mission statement Conversa School</h3>

                        <p>
                            <img src={prefixLink(missionTheme1Img)} alt="studenten met leerboek" style={{float: 'right', width: '40%'}}/> Wil jij nog beter worden in Pools? Of heb je de basis van de Poolse taal al onder de knie – maar wil je jouw gesprekken naar een hoger niveau brengen? Of misschien zijn je ouders wel Pools, alleen is het jou nooit gelukt om verder te komen dan simpele gesprekken?
                            <br/>
                            <br/>
                        ...
                        {/*<div className="row">
                            <div className="col s12 l8">
                                <p>Wil jij nog beter worden in Pools? Of heb je de basis van de Poolse taal al onder de knie – maar wil je jouw gesprekken naar een hoger niveau brengen? Of misschien zijn je ouders wel Pools, alleen is het jou nooit gelukt om verder te komen dan simpele gesprekken?
                                </p>
                            ...
                            <div className="col s12 l4">
                                <img src={prefixLink(missionTheme1Img)} alt="studenten met leerboek"/>
                            </div>
                        </div>*/}
                        ...
                        <div className="row flex-boxes">
                            <div className="col s12 m12 l4 white-text" id="mission" style={{backgroundColor: block1Color}}>
                                <div className="icon-block">
                                    ...
                                    <p className="light">Een origineel gesprek kunt houden in het Pools</p>
                                </div>
                            </div>
                            ...
                            <div className="col s12 m12 l4 white-text" id="courses" style={{backgroundColor: block2Color}}>
                                <div className="icon-block">
                                    ...
                                    <p className="light">Goedlopende correcte zinnen in het Pools kunt maken met de woorden en grammatica die je al kent</p>
                                </div>
                            </div>
                            ...
                            <div className="col s12 m12 l4 white-text" id="nuggets" style={{backgroundColor: block3Color}}>
                                <div className="icon-block">
                                    ...
                                    <p className="light">Binnen 1 jaar op niveau B1/B2 in de Poolse taal kunt komen<a href="#footnote">*</a></p>
                                </div>
                            </div>
                        </div>

                        {/*<ul className="browser-default">
                            <li><img src={prefixLink(iconBulbImg)} alt="origineel idee icoon"/> Een origineel gesprek kunt houden in het Pools</li>
                            <li><img src={prefixLink(iconConversationImg)} alt="gesprek icoon"/> Goedlopende correcte zinnen in het Pools kunt maken met de woorden en grammatica die je al kent</li>
                            <li><img src={prefixLink(iconGrowImg)} alt="groei icoon"/>  Binnen 1 jaar op niveau B1/B2 in de Poolse taal kunt komen<a href="#footnote">*</a></li>
                        </ul>*/}
                        ...
                        <p>
                            <img src={prefixLink(missionTheme2Img)} alt="groep van overleggende mensen" style={{float: 'left', width: '40%', marginRight: '0.5em'}}/>
                            ...
                            Neem dan contact op met ons via ons <a href="/#contact">contactformulier</a>. Wij helpen je graag om al jouw doelen in de Poolse taal te bereiken.
                            <br/>
                            <br/>
                            Dziękujemy bardzo i czekamy na Was!
                        </p>

                        {/*<p>Heb je interesse om samen met ons aan de slag te gaan om het niveau van jouw Poolse taal naar een hoger niveau te brengen?
                        ...
                        <img src={prefixLink(missionTheme2Img)} alt="groep van overleggende mensen"/>
*/}

                        <p id="footnote" style={{color: '#8a8a8a', borderTop: '1px solid #8a8a8a', marginTop: '4em'}}>
